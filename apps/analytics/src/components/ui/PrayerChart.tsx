    ...
    <Card className={cn('bg-white', className)}>
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            <CardTitle>Prayer Meetings Analytics</CardTitle>
            <CardDescription>
              Prayer meetings tracked over the last 5 weeks
            </CardDescription>
          </div>
      ...
      <CardContent>
        ...
        <div className="flex justify-between text-sm text-gray-600 pt-4">
          ...
          <span className="text-blue-600">Trending up 12%</span>
        </div>
      </CardContent>
    </Card>
  );
