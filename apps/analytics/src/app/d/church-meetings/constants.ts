import { Meeting, AttendanceSubmission, EvangelismSession, FollowUpSession, ChartData, AttendanceRecord } from './types';
...
export const FIRST_TIMERS_EXAMPLES = ['Razak Okoya', 'Bola Ahmed Tinubu', 'Layal Tinubu'];

export const FELLOWSHIPS = ['Oke-afa Fellowship', 'Ire-Akari Fellowship', 'Ago-Ejigbo Fellowship'];
export const CELLS = ['Oke-afa Cell 1', 'Aswan Cell', 'Ile-Iwe Cell'];
