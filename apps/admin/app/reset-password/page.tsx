...
const EmailSection = ({
  ...
  const resetPasswordMutation = useMutation({
    ...
    onSuccess: () => {
      toast.success(
        "You have successfully requested password reset, please check your email"
      );
  ...
  return (
    <div className="flex flex-col items-center gap-4 w-[450px] px-[56px]">
      ...
      <Image
        ...
        priority
      />
      <p className="text-[16px] text-center mb-8 pt-2">
        We have sent you a password reset link to the email you provided.
        Kindly follow the link to reset your password.
      </p>
